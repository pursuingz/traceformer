...
### sfG+loss_F — sfG + 单帧 boundary loss_F(commit `fd9cd14`,λ_deform=0.1 未校准,@45000)
```
===== eval metrics =====
windows: 56 total, 14 full-horizon (rollout 指标分母)
MSE first-chunk : 1.565120e-05
MSE full-rollout: 6.092581e-03
Chamfer  (mean) : 7.576677e-02
MSE per abs-frame: f5=5.329953e-06(n=14), f10=5.819854e-04(n=14), f15=4.579493e-03(n=14), f20=1.420089e-02(n=14)
loss_F (pred)   : 0.000000e+00
loss_F (gt ref) : 0.000000e+00
--- 物理合理性 ---
速度误差 vMSE   : 1.438054e-04
加速度误差 aMSE : 8.688943e-06
体积相对误差    : 7.121%
体积自漂移      : 8.939%
体积自漂移(GT)  : 5.014%
超额自漂移      : +3.925%
...
eval_v10_particlegrid_8L.yaml 结果(@45000,🔴 主指标净负 +50.4% vs sfG+F λ.001 基线):
```
===== eval metrics =====
  windows: 56 total, 14 full-horizon (rollout 指标分母)
  MSE first-chunk : 1.937698e-05   (全 56 窗口, 逐样本对齐)
  MSE full-rollout: 4.478152e-03   (仅 14 全程窗口)
  Chamfer  (mean) : 6.304004e-02
  MSE per abs-frame: f5=5.223410e-06(n=14), f10=4.363801e-04(n=14), f15=3.541339e-03(n=14), f20=1.064523e-02(n=14)
  loss_F (pred)   : 0.000000e+00
  loss_F (gt ref) : 0.000000e+00
  --- 物理合理性 ---
  速度误差 vMSE   : 1.162869e-04
  加速度误差 aMSE : 8.494550e-06
  体积相对误差    : 7.309%
  体积自漂移      : 9.272%
  体积自漂移(GT)  : 5.014%
  超额自漂移      : +4.258%
